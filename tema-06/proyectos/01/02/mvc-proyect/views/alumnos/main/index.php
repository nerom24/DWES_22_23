                ...
                <tbody>
                    ...
                    <?php foreach ($this->alumnos as $alumno): ?>
                        <tr>
                            ...
                            <!-- Columna de acciones -->
                            <td>
                                <a href="alumnos/delete/<?=$alumno->id?>" title="Eliminar" ><i class="bi bi-trash-fill" onclick="return confirm('Confimar elimación del alumno')"></i></a>
                                <a href="alumnos/editar/<?=$alumno->id?>" title="Editar"><i class="bi bi-pencil-fill"></i></a>
                                <a href="alumnos/mostrar/<?=$alumno->id?>" title="Mostrar"><i class="bi bi-eye-fill"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>   
                </tbody>
