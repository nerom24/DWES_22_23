                        ...
                        <form method="POST" action="<?= URL ?>register/validate">
                            ...
                            <div class="mb-3 row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <a class="btn btn-secondary" href="https://educacionadistancia.juntadeandalucia.es/centros/cadiz/pluginfile.php/305977/mod_assign/introattachment/0/<?=URL?>login" role="button">Cancelar</a>
