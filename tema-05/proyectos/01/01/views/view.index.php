                ...
                <tbody>
                    ...
                    <?php foreach ($alumnos as $alumno): ?>
                        <tr>
                            ...
                            <!-- Columna de acciones -->
                            <td>
                                <a href="eliminar.php?id=<?=$alumno->id?>" ><i class="bi bi-trash-fill"></i></a>
                                <a href="editar.php?id=<?=$alumno->id?>"><i class="bi bi-pencil-fill"></i></a>
                                <a href="mostrar.php?id=<?=$alumno->id?>"><i class="bi bi-eye-fill"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>   
                </tbody>
