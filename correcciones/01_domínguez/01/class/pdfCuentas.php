<?php
    ...
    class pdfCuentas extends FPDF{
        ...
        public function Titulo(){
            ...
            $this->Cell(0,10, iconv ("UTF-8","ISO-8859-1", 'Listado de cuentas'), 1, 1);
        ...
        public function encabezado(){
            ...
            $this->Cell(45, 7, iconv ("UTF-8","ISO-8859-1", "Numero Cuenta"), 'B', 0, 'R', true);
            $this->Cell(40, 7, iconv ("UTF-8","ISO-8859-1", "Nombre Cliente"), 'B', 0, 'L', true);
            $this->Cell(35, 7, iconv ("UTF-8","ISO-8859-1", "Fecha Alta"), 'B', 0, 'R', true);
            $this->Cell(40, 7, iconv ("UTF-8","ISO-8859-1", "Fecha Movimiento"), 'B', 0, 'R', true);
