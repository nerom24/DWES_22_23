<?php
    ...
    class pdfUsuarios extends FPDF{
        ...
        public function Titulo(){
            ...
            $this->Cell(0,10, iconv ("UTF-8","ISO-8859-1", 'Listado de usuarios'), 1, 1);
        ...
        public function encabezado(){
            ...
            $this->Cell(60, 7, iconv ("UTF-8","ISO-8859-1", "Email"), 'B', 0, 'L', true);
            $this->Cell(60, 7, iconv ("UTF-8","ISO-8859-1", "Rol"), 'B', 1, 'L', true);
        }
