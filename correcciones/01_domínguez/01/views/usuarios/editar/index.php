...
<body>
    ...
    <div class="container">
        ...
        <form method="post" action="<?= URL ?>usuarios/update/<?= $this->usuario->id ?>">
        <div class="mb-3">
                <label for="nombre" class="form-label">Nombre</label>
                <input type="text" class="form-control <?= (isset($this->errores['nombre']))? 'is-invalid' : null ?>" id="nombre" aria-describedby="nombre" name="nombre" value="<?= $this->usuario->name; ?>">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control <?= (isset($this->errores['email']))? 'is-invalid' : null ?>" id="email" aria-describedby="email" name="email" placeholder="ejemplo@email.com" value="<?= $this->usuario->email; ?>">
                <!-- Mostrar posible error -->
