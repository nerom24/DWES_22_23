        ...
        <div class="mb-3">
            <form action="<?= URL ?>cuentas/update/<?= $this->id ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <?= (isset($this->errores["num_cuenta"])) ? "is-invalid" : null ?>" name="num_cuenta" value="<?= $this->cuenta->num_cuenta ?>" disabled>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control 
                    <?= (isset($this->errores["saldo"])) ? "is-invalid" : null ?>" name="saldo" id="" value="<?= $this->cuenta->saldo ?>" readonly>
