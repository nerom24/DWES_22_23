                ...
                <?php foreach ($this->cuentas as $cuenta) : ?>
                    <tr>
                        ...
                        <td style="display:flex; justify-content:space-between;">
                            <a href="<?= URL ?>cuentas/delete/<?= $cuenta->id ?>" title="Eliminar" <?= (!in_array($_SESSION["id_rol"], $GLOBALS["eliminar"])) ? 'disabled' : null ?>" onclick="return confirm('¿Quieres Borrar?')"> <i class="bi bi-trash-fill"></i> </a>
                            <a href="<?= URL ?>cuentas/editar/<?= $cuenta->id ?>" title="Editar" <?= (!in_array($_SESSION["id_rol"], $GLOBALS["editar"])) ? 'disabled"' : null ?>"> <i class="bi bi-pencil-fill"></i> </a>
                            <a href="<?= URL ?>cuentas/mostrar/<?= $cuenta->id ?>" title="Mostrar" <?= (!in_array($_SESSION["id_rol"], $GLOBALS["mostrar"])) ? 'disabled"' : null ?>"> <i class="bi bi-eye-fill"></i> </a>
