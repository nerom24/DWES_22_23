    ...
    public function validate()
    {
        ...
        if (!empty($errores)) {
            ...
            try {
                ...
                // Autentificación
                $mail->Username = 'sergiomateos00@gmail.com';
                $mail->Password = 'lynrraguzvklghyd';

                // Dirección de remitente
                $mail->setFrom("sergiomateos00@gmail.com", "GesBank");

                // Dirección de respuesta
                $mail->addReplyTo('sergiomateos00@gmail.com', 'Email respuesta');
                ...
                // Mensaje
                $mail->Body = "Bienvenid@ a GesBank, desde aquí podrás gestionar la sucursal de tu banco!<br>Nombre: <b>" . $name . "</b><br>Usuario:<b>" . $email . "</b>";
