...
class pdfUser  extends FPDF
{
    ...
    public function CabListadoUsuario()
    {
        $this->SetFont('Times', 'B', 10);
        $this->SetFillColor(200);
        $this->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', 'Id: '), 'B', 0, 'L');
        $this->Cell(50, 7, iconv('UTF-8', 'ISO-8859-1', 'Nombre : '), 'B', 0, 'L');
        $this->Cell(50, 7, iconv('UTF-8', 'ISO-8859-1', 'Email: '), 'B', 0, 'L');
        $this->Cell(50, 7, iconv('UTF-8', 'ISO-8859-1', 'Perfil: '), 'B', 1, 'R');
    }
}
