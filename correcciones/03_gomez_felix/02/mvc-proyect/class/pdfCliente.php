...
class pdfCliente  extends FPDF
{
    ...
    public function CabListadoCliente()
    {
        $this->SetFont('Times', 'B', 10);
        $this->SetFillColor(200);
        $this->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', 'Id: '), 'B', 0, 'L');
        $this->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', 'Nombre: '), 'B', 0, 'L');
        $this->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', 'Apellidos: '), 'B', 0, 'L');
        $this->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', 'Ciudad: '), 'B', 0, 'L');
        $this->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', 'Email: '), 'B', 0, 'L');
        $this->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', 'Dni: '), 'B', 1, 'R');
    }
}
