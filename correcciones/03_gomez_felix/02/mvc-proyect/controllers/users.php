...
class Users extends Controller
{
    ...
    public function pdf($param = [])
    {
        ...
        if (!isset($_SESSION['id'])) {
            ...
            $pdf->Titulo();
            $pdf->CabListadoUsuario();
            $pdf->SetFillColor(200);
            $fondo=true;
            foreach ($usuarios as $user) {
                $pdf->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', $user->id), 'B', 0, 'L', $fondo);
                $pdf->Cell(50, 7, iconv('UTF-8', 'ISO-8859-1', $user->name), 'B', 0, 'L', $fondo);
                $pdf->Cell(50, 7, iconv('UTF-8', 'ISO-8859-1', $user->email), 'B', 0, 'L', $fondo);
                $pdf->Cell(50, 7, iconv('UTF-8', 'ISO-8859-1', $user->perfil), 'B', 1, 'R', $fondo);
                $fondo=!($fondo);
            };
