...
class Clientes extends Controller
{
    ...
    public function pdf($param = [])
    {
        ...
        if (!isset($_SESSION['id'])) {
            ...
            $pdf->Titulo();
            $pdf->CabListadoCliente();
            $pdf->SetFillColor(200);
            $fondo=true;
            foreach ($clientes as $cliente) {
                $pdf->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', $cliente->id), 'B', 0, 'L', $fondo);
                ...
                $pdf->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', $cliente->ciudad), 'B', 0, 'L', $fondo);
                $pdf->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', $cliente->email), 'B', 0, 'L', $fondo);
                $pdf->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', $cliente->dni), 'B', 1, 'R', $fondo);
                $fondo=!($fondo);
