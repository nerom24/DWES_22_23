...
class Cuentas extends Controller
{
    ...
    function update($param = [])
    {
        ...
        if (!isset($_SESSION['id'])) {
            ...
            //Validamos id_cliente clave ajena
            //Valor obligatorio
            //valor numérico, ha de existir en la tabla clientes.
    ...
    public function pdf($param = [])
    {
        ...
        if (!isset($_SESSION['id'])) {
            ...
            $pdf->Titulo();
            $pdf->CabListadoCuenta();
            $pdf->SetFillColor(200);
            $fondo=false;
            foreach ($cuentas as $cuenta) {
                $pdf->Cell(10, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->id), '0', 0, 'L', $fondo);
                $pdf->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->num_cuenta), '0', 0, 'L', $fondo);
                $pdf->Cell(45, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->nombre. ", ". $cuenta->apellidos), '0', 0, 'L', $fondo);
                $pdf->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->fecha_alta), '0', 0, 'L', $fondo);
                $pdf->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->num_movtos), '0', 0, 'L', $fondo);
                $pdf->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->saldo), '0', 1, 'R', $fondo);
                $fondo=!($fondo);
            };
