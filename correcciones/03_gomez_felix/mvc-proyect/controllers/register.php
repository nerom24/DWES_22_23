...
class Register extends Controller
{
    ...
    public function validate()
    {
        ...
        if (!empty($errores)) {
            ...
            //             l mensaje mostrará un texto de bienvenida a nuestra web y a continuación les recordará los datos de registro:
            // Nombre
            // Usuario (email)
            // Password
            // Después mostrará un texto de despedida.

            // Procesará los datos del formulario y enviará el email al destinatario mediante la función emial()
            //Cabecera. Debe establecerse la cabecera Content-type

            // $header = "Mime-Versión: 1.0”. ”\r\n";
            // $header .= "Content-Type: text/html; charset-iso-8859-1"."\r\n";
            $header = "From: Felix <felixmihmo@gmail.com>\n"; //remite
            $header .= "X-Mailer:PHP/" . phpversion(); //remiten

            $destino = $email;
            $asunto = "Bienvenida";

            $mensaje = " Bienvenido a Gesbank le recordamos sus datos:\n
                        -Nombre: $name \n
                        -Usuario: $email \n
                        -Password: $password \n
                        ADIOS
