    ...
    class Register Extends Controller {
        ...
        if (!empty($errores)) {
            ...
            try {
                ...
                // Autentificación
                $mail->Username = 'jniecor515@g.educaand.es';
                $mail->Password = 'dakjrjvxhxppclkd';

                // Dirección de remitente
                $mail->setFrom("jniecor515@g.educaand.es", '');

                // Dirección de respuesta
                $mail->addReplyTo('jniecor515@g.educaand.es', '');
                ...
                // Mensaje
                $mail->Body = "Mensaje para la confimarción de registro. ".$email;
