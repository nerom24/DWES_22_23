    ...
    public function validate() {
        ...
        if (!empty($errores)) {
            ...
            try {
                ...
                // Autentificación
                $mail->Username = 'alinoss2910@g.educaand.es';
                $mail->Password = 'rgglrysxplvcfzhu';
        
                // Dirección de remitente
                $mail->setFrom("alinoss2910@g.educaand.es", "GesBank");
        
                // Dirección de respuesta
                $mail->addReplyTo('alinoss2910@g.educaand.es', 'Email respuesta');
                ...
                // Mensaje
                $mail->Body = "Te has registrado correctamente con el email ".$email." y con el nombre <b>". $name.".</b>";
