    ...
    public function Pdf($param = [])
    {
        ...
        if (!isset($_SESSION['id'])) {
            ...
            foreach ($cuentas as $cuenta) {
                $pdf->Cell(10, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->id), 'B', 0, 'L', true);
                $pdf->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->num_cuenta), 'B', 0, 'L', true);
                $pdf->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->id_cliente), 'B', 0, 'C', true);
                $pdf->Cell(50, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->fecha_alta), 'B', 0, 'L', true);
                $pdf->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->num_movtos), 'B', 0, 'C', true);
