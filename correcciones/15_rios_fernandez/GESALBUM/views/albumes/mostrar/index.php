    ...
    <div class="container">
        ...
        <div class="mb-3">
            <form action="<?= URL ?>albumes/update/<?= $this->id ?>" method="POST">
                ...
                <div class="container">
                    <?php
                    $directory = './imagenes/' . $this->album->carpeta . '/';
                    $imagenes = glob($directory . "*.*", GLOB_BRACE);
                    ...
                    foreach ($imagenes as $image) {
                        ...
                        <div>
                            ...
                            <img src="../.' . $image . '"  alt="Imagen no cargada" id="imagen" class="bd-placeholder-img card-img-top">
