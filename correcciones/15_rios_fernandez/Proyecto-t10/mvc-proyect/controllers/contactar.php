...
class Contactar extends Controller
{
    ...
    function validar($param = [])
    {
        ...
        try {
            ...
            $mail->Username = 'ajuan240217@gmail.com';
            $mail->Password = 'ieczkomstpybyfqt';

            // Dirección de remitente
            $mail->setFrom($email, $email);

            // Dirección de respuesta
            $mail->addReplyTo('ajuan240217@gmail.com', 'Email de respuesta');

            // Dirección de envio
            $mail->addAddress('ajuan240217@gmail.com', 'Antonio Juan');
