...
class Albumes extends Controller{
    ...
    function create($param = []) {
        ...
        $new_album = new Album(null,$titulo,$descripcion,$autor,$fecha,$lugar,$categoria,$etiquetas,null,0,$carpeta,null,null);
    ...
    function update($param = []){
        ...
        if (!isset($_SESSION['id'])) {
            ...
            $etiquetas = filter_var($_POST['etiquetas'] ??= '', FILTER_SANITIZE_SPECIAL_CHARS);
            $carpeta = filter_var($_POST['carpeta'] ??= '', FILTER_SANITIZE_SPECIAL_CHARS);
            $edit_cliente = new Album(null,$titulo,$descripcion,$autor,$fecha,$lugar,$categoria,$etiquetas,null,null,$carpeta,null,null);
            $id = $param[0];
    ...
    function mostrar($param = []) {
        ...
        $this->model->increaseAlbumViews($id);
    ...
    function subir($param = []){
        ...
        if (!isset($_SESSION['id'])) {
            ...
            $this->model->updateAlbumNumPhotos($this->view->id, $num_fotos);
        }
    }
    ...
    function upload($param = []) {
        ...
        if (!isset($_SESSION['id'])) {
            ...
            $_SESSION['mensaje'] = 'El album se ha actualizado correctamente';
            header("Location:" . URL . "albumes");
