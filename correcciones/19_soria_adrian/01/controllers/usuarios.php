    ...
    class Usuarios extends Controller {
        ...
        function render(){
            ...
            if (!isset($_SESSION['id'])) {
                ...
                //en la carpeta views tengo que crear la carpeta usuarios
                //dentro de la carpeta usuarios creo main
                //en la main creo index.php que corresponde a la vista que muestra usuarios
            }
        ...
        public function pdf(){
            ...
            if (!isset($_SESSION['id'])) {
                ...
                require('class/pdfUsers.php');

                $pdf= new pdfUsers('P', 'mm', 'A4');
                ...
                # Muestro el enncabezado de los usuarios
                $pdf->Linea_users();
                ...
                foreach($usuarios as $usuario){
                    ...
                    $pdf->Cell(40, 7, iconv ("UTF-8","ISO-8859-1", $usuario->id), 'B', 0, 'L', $fondo);
                    $pdf->Cell(55, 7, iconv ("UTF-8","ISO-8859-1", $usuario->name), 'B', 0, 'L', $fondo);
                    $pdf->Cell(50, 7, iconv ("UTF-8","ISO-8859-1", $usuario->email), 'B', 0, 'L', $fondo);
                    $pdf->Cell(45, 7, iconv ("UTF-8","ISO-8859-15", $usuario->rol), 'B', 1, 'L', $fondo);
