<?php
    ...
    class pdfMovimientos extends FPDF{
        ...
        public function Titulo(){
            ...
            $this->Cell(0,10, iconv ("UTF-8","ISO-8859-1", 'Lista de movimientos'), 1, 1);
            $this->Cell(60,10, iconv ("UTF-8","ISO-8859-1", "Fecha: "), 1, 0, 'R', true );
            $this->Cell(0,10, iconv ("UTF-8","ISO-8859-1", date('d-m-Y H:i:s')), 1, 1);
            $this->ln(5);
        }

        public function Linea_movim(){
            $this->SetFillColor(240);
            $this->Cell(10, 7, iconv ("UTF-8","ISO-8859-1", "Id"), 'B', 0, 'R', true);
            $this->Cell(50, 7, iconv ("UTF-8","ISO-8859-1", "Nº Cuenta"), 'B', 0, 'L', true);
            $this->Cell(37, 7, iconv ("UTF-8","ISO-8859-1", "Fecha"), 'B', 0, 'L', true);
            $this->Cell(30, 7, iconv ("UTF-8","ISO-8859-1", "Tipo"), 'B', 0, 'L', true);
            $this->Cell(33, 7, iconv ("UTF-8","ISO-8859-1", "Cantidad"), 'B', 0, 'L', true);
            $this->Cell(30, 7, iconv ("UTF-8","ISO-8859-1", "Saldo"), 'B', 1, 'L', true);
        }
