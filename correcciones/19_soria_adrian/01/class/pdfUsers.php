<?php
    ...
    class pdfUsers extends FPDF{
        ...
        public function Titulo(){
            ...
            $this->Cell(0,10, iconv ("UTF-8","ISO-8859-1", 'Lista de usuarios'), 1, 1);
            $this->Cell(60,10, iconv ("UTF-8","ISO-8859-1", "Fecha: "), 1, 0, 'R', true );
            $this->Cell(0,10, iconv ("UTF-8","ISO-8859-1", date('d-m-Y H:i:s')), 1, 1);
            $this->ln(5);
        }

        public function Linea_users(){
            $this->SetFillColor(240);
            $this->Cell(40, 7, iconv ("UTF-8","ISO-8859-1", "Id"), 'B', 0, 'L', true);
            $this->Cell(60, 7, iconv ("UTF-8","ISO-8859-1", "Nombre"), 'B', 0, 'L', true);
            $this->Cell(50, 7, iconv ("UTF-8","ISO-8859-1", "email"), 'B', 0, 'L', true);
            $this->Cell(40, 7, iconv ("UTF-8","ISO-8859-1", "rol"), 'B', 1, 'L', true);
        }
