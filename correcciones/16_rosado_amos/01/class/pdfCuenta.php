<?php
    ...
    class pdfCuenta extends FPDF{
        ...
        public function Titulo(){
            ...
            $this->Cell(0,10,iconv('UTF-8', 'ISO-8859-1', 'Cuenta Clientes'),1 , 1);
        ...
        public function CabListadoArticulos(){
            ...
            $this->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', 'Numero Cuenta '), 'B', 0, 'L');
            $this->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', ' '), 'B', 0, 'L');
            $this->Cell(50, 7, iconv('UTF-8', 'ISO-8859-1', 'Fecha Alta '), 'B', 0, 'L');
            $this->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', 'Movimientos '), 'B', 0, 'L');
