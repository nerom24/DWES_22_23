        ...
        sec_session_start();
         ...
         if (!isset($_SESSION['id'])) {
            ...
            foreach ($usuarios as $usuario){
                $pdf->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', $usuario->id), 'B', 0, 'I', true);
                $pdf->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', $usuario->name), 'B', 0, 'L', true);
                $pdf->Cell(60, 7, iconv('UTF-8', 'ISO-8859-1', $usuario->email), 'B', 0, 'L', true);
                $pdf->Cell(60, 7, iconv('UTF-8', 'ISO-8859-1', $usuario->perfil), 'B', 1, 'L', true);
