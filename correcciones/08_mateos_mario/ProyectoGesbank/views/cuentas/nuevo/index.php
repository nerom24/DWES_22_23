            ...
            <form action="<?= URL ?>cuentas/create" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <?=(isset($this->errores["num_cuenta"]))? "is-invalid":null?>"
                     name="num_cuenta" value="<?= $this->cuenta->num_cuenta ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control <?=(isset($this->errores["fecha_alta"]))? "is-invalid":null?>" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?=(isset($this->errores["saldo"]))? "is-invalid":null?>" 
                    name="saldo" id="" value="<?= $this->cuenta->saldo ?>">
