...
<head>
    ...
    <title>Nuevo Gestion Album</title>
</head>
<body>
        ...
        <div class="mb-3">
            <form action="<?= URL ?>albumes/update/<?=$this->id?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <?= (isset($this->errores["fecha"])) ? "is-invalid" : null ?>" name="fecha" value="<?= $this->album->fecha ?>" disabled>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control
                    <?= (isset($this->errores["lugar"])) ? "is-invalid" : null ?>" name="lugar" value="<?= $this->album->lugar ?>" disabled>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control 
                    <?= (isset($this->errores["categoria"])) ? "is-invalid" : null ?>" name=" categoria" id="" value="<?= $this->album->categoria ?>" disabled>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control
                     <?= (isset($this->errores["num_fotos"])) ? "is-invalid" : null ?>" name="num_fotos" value="<?= $this->album->num_fotos ?>" disabled>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control
                     <?= (isset($this->errores["num_visitas"])) ? "is-invalid" : null ?>" name="num_visitas" value="<?= $this->album->num_visitas ?>" disabled>
