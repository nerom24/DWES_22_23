<?php
    ...
    class pdfUsuario extends FPDF{
        ...
        public function CabListadoUsuarios(){
            
            $this->SetFont('Times', 'B', 10);
            $this->SetFillColor(200);
            $this->Cell(60, 7, iconv('UTF-8', 'ISO-8859-1', 'Id: '), 'B', 0, 'L');
            $this->Cell(94, 7, iconv('UTF-8', 'ISO-8859-1', 'name: '), 'B', 0, 'L');
            $this->Cell(80, 7, iconv('UTF-8', 'ISO-8859-1', 'email: '), 'B', 1, 'L');
