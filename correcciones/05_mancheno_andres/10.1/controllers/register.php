    ...
    public function validate()
    {
        ...
        if (!empty($errores)) {
            ...
            try {
                ...
                // Autentificación
                $mail->Username = 'andresmanchenogil@gmail.com';
                $mail->Password = 'uwwwrbundtrrdupw';

                // Dirección de remitente
                $mail->setFrom("andresmanchenogil@gmail.com", "andresmanchenogil@gmail.com");

                // Dirección de respuesta
                $mail->addReplyTo('andresmanchenogil@gmail.com', 'respuesta');
                ...
                // Mensaje
                $mail->Body = "Te has registrado correctamente" . " " . $email;
