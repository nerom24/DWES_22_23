        ...
        sec_session_start();
         ...
         if (!isset($_SESSION['id'])) {
            ...
            foreach ($cuentas as $cuenta){
                ...
                $pdf->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->nombre ." ".  $cuenta->apellidos), 'B', 0, 'L', true);
                $pdf->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->num_cuenta), 'B', 0, 'L', true);
                $pdf->Cell(57, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->fecha_alta), 'B', 0, 'L', true);
                $pdf->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->num_movtos), 'B', 0, 'L', true);
