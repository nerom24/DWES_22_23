      ...
      <div class="d-flex">
        ...
        <div class="collapse navbar-collapse" id="exCollapsingNavbar">
          <ul class="nav navbar-nav flex-row justify-content-between ml-auto">
            <li class="nav-item"><a href="<?= URL ?>login" class="nav-link active">Iniciar Sesion</a></li>
            <li class="nav-item"><a href="<?= URL ?>register" class="nav-link active">Registrarse</a></li>
          </ul>
        </div>
