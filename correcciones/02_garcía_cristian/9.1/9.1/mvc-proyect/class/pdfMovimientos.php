<?php
    ...
    class pdfMovimientos extends FPDF{
        ...
        public function Header(){
            ...
            $this->Image("logo/movimiento.png", 10,5, 20);
            $this->SetFont('Arial', 'B', 10);            
            $this->Cell(15, 16, '', "B", 0, 'C');
            $this->Cell(45, 16, 'GESBANK 1.0', "B", 0, 'C');
            $this->Cell(60, 16, 'Cristian Garcia Garrido', "B", 0, 'C');
            $this->Cell(70, 16, '2DAW - ' . date('d/m/Y'), "B", 1, 'C');
