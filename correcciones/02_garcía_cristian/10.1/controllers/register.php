    ...
    public function validate()
    {
        ...
        if (!empty($errores)) {
            ...
            try {
                ...
                $mail->setFrom("cristianbornos4@gmail.com", "cristianbornos4@gmail.com");

                // Dirección de respuesta
                $mail->addReplyTo('cristianbornos4@gmail.com', 'respuesta');
                ...
                // Mensaje
                $mail->Body = "Hola bienvenido, te has registrado correctamente" . " " . $email;
