    ...
    public function pdf($param = []) {
        ...
        sec_session_start();
         ...
         if (!isset($_SESSION['id'])) {
            ...
            $pdf->CabListadoUsuarios();
            $pdf->SetFont('Times', 'B', 10);
            $pdf->SetFillColor(200);

        
            foreach ($usuarios as $usuario){
                $pdf->Cell(60, 7, iconv('UTF-8', 'ISO-8859-1', $usuario->id), 'B', 0, 'I', true);
                $pdf->Cell(94, 7, iconv('UTF-8', 'ISO-8859-1', $usuario->name), 'B', 0, 'L', true);
                $pdf->Cell(80, 7, iconv('UTF-8', 'ISO-8859-1', $usuario->email), 'B', 1, 'L', true);
