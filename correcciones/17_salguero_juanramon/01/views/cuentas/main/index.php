                ...
                <?php foreach ($this->cuentas as $cuenta) : ?>
                    <tr>
                        ...
                        <td style="display:flex; justify-content:space-between;">
                            <div class="btn-group">
                                <a href="<?= URL ?>cuentas/delete/<?= $cuenta->id ?>" title="Eliminar" class="btn <?= (!in_array($_SESSION["id_rol"], $GLOBALS["eliminar"])) ? ' btn-secondary disabled' : 'btn-primary' ?>"  onclick="return confirm('¿Quieres Borrar?')"> <i class="bi bi-trash"></i> </a>
                                <a href="<?= URL ?>cuentas/editar/<?= $cuenta->id ?>" title="Editar"  class="btn  <?= (!in_array($_SESSION["id_rol"], $GLOBALS["editar"])) ? 'btn-secondary disabled"' : 'btn-primary' ?>"> <i class="bi bi-pencil"></i> </a>
                                <a href="<?= URL ?>cuentas/mostrar/<?= $cuenta->id ?>" title="Mostrar"  class="btn  <?= (!in_array($_SESSION["id_rol"], $GLOBALS["mostrar"])) ? 'btn-secondary disabled"' : 'btn-primary'?>"> <i class="bi bi-eye"></i> </a>
