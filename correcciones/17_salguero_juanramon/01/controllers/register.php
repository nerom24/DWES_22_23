    ...
    public function validate()
    {
        ...
        if (!empty($errores)) {
            ...
            try {
                ...
                $mail->Port = 465;
                $mail->Username = 'errayo700@gmail.com';
                $mail->Password = 'lobmjiqstskkztmx';
                $mail->setFrom("errayo700@gmail.com", "Juan Ramón Salguero Mateos");
                $mail->addReplyTo('errayo700@gmail.com', 'Confirmar registro');
                $mail->addAddress($email, "Cliente");
                $mail->Subject = "Confirmación de registro";
                $mail->Body = "Es siguiente usuario se acaba de registrar en la web ". $name . "Con el correo " . $email;
                $mail->send();
