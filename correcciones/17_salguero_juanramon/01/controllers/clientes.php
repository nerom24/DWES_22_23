        ...
        sec_session_start();
         ...
         if (!isset($_SESSION['id'])) {
            ...
            foreach ($clientes as $cliente){
                ...
                $pdf->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', $cliente->apellidos), 'B', 0, 'L', $fondo);
                $pdf->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', $cliente->nombre), 'B', 0, 'L', $fondo);
                $pdf->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', $cliente->telefono), 'B', 0, 'L', $fondo);
                $pdf->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', $cliente->dni), 'B', 0, 'L', $fondo);
                $pdf->Cell(50, 7, iconv('UTF-8', 'ISO-8859-1', $cliente->email), 'B', 1, 'L', $fondo);
