        ...
        sec_session_start();
         ...
         if (!isset($_SESSION['id'])) {
            ...
            foreach ($cuentas as $cuenta){
                ...
                $pdf->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->num_cuenta), 'B', 0, 'L', $fondo);
                $pdf->Cell(50, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->apellidos.' '.$cuenta->nombre), 'B', 0, 'L', $fondo);
                $pdf->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->num_movtos), 'B', 0, 'L', $fondo);
                $pdf->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', $cuenta->saldo), 'B', 1, 'L', $fondo);
