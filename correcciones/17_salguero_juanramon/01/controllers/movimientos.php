...
class Movimientos extends Controller
{
    ...
    public function pdf($param = []) {
        ...
        sec_session_start();
         ...
         # Compruebo el usuario identificado
         if (!isset($_SESSION['id'])) {
            ...
            $this->view->id = $param[0];
            $movimientos=$this->model->get($this->view->id);
            ...
            foreach ($movimientos as $movimiento){
                ...
                $pdf->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', $movimiento->num_cuenta), 'B', 0, 'L', $fondo);
                $pdf->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', $movimiento->concepto), 'B', 0, 'L', $fondo);
                $pdf->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', $movimiento->tipo), 'B', 0, 'L', $fondo);
                $pdf->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', $movimiento->cantidad), 'B', 0, 'L', $fondo);
                $pdf->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', $movimiento->saldo), 'B', 1, 'L', $fondo);
